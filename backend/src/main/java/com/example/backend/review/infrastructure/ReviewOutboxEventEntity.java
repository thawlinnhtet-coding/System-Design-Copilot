...
public class ReviewOutboxEventEntity {
	...
	public UUID getId(){return id;} public UUID getReviewJobId(){return reviewJobId;} public boolean pending(){return "PENDING".equals(status);} public void published(Instant now){status="PUBLISHED";publishedAt=now;}
}
